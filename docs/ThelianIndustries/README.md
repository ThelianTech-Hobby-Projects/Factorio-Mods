...
- **Plans** are status-controlled: the Idea Backlog retains speculative ideas and candidates, while the metallurgy decision record contains the current locked metallurgy checkpoint.
