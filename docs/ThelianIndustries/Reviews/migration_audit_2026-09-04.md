...
| TI-CONFLICT-005 | **Superseded by 2026-09-07 metallurgy decision record** | The prior migration conflict is retained as evidence. [TI_Metallurgy_Plan.md](../Plans/InProgress%20Plans/TI_Metallurgy_Plan.md), Decision 3.33, now locks the primary allocation; see the [open questions](../00_Project/05_Open_Questions_and_Research_Log.md) for remaining profile and balance work. |
