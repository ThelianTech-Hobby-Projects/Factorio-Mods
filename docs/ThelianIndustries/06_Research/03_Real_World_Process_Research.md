# Real-World Process Research

**Status: Placeholder / Research Needed**

## Current status

The current Thelian Industries legacy planning sources do not define a real-world-process research program, approved reference sources, or rules for translating external material into gameplay design.
...
- The intended relationship between research evidence and gameplay design decisions.
- A record of assumptions and review decisions for any future research.
