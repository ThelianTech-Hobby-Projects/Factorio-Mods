local speed = settings.startup["Swimming-speed"].value
local is_deep_swimmable = settings.startup["Swimming-is-deep-swimmable"].value
local deepspeed = settings.startup["Swimming-deep-speed"].value
...
for _,water in pairs(waters) do
    ...
    data.raw.tile[water].walking_sound = {
        {
            filename = "__thelian-utils__/sounds/swimming/water-1.ogg",
            volume = 0.8
        },
        {
            filename = "__thelian-utils__/sounds/swimming/water-2.ogg",
            volume = 0.8
        },
        {
            filename = "__thelian-utils__/sounds/swimming/water-3.ogg",
            volume = 0.8
        }
    }
end
...
local function make_ripple(prefix, nr, color)
    data:extend{{
                    ...
                    animation =
                    {
                        filename = "__thelian-utils__/graphics/swimming/ripple" .. nr .. ".png",
                        priority = "extra-high",
                        width = 192,
                        height = 128,
                        frame_count = 48,
